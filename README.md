...
## [Проект 3 - E-Commerce](https://github.com/RudkovYaroslav/E-Commerce)

Третий личный проект, целью которого было построение полного аналитического цикла: от проверки и обработки сырых данных до визуализации результатов и формулировки бизнес-выводов. В рамках проекта:
- Использовал PostgreSQL для проверки качества данных, расчета ключевых бизнес-метрик и агрегации данных
- Выявил некорректное сравнение отчетных периодов из-за неполных данных за один из годов и скорректировал расчеты для сопоставимого анализа
- Проанализировал динамику выручки, количества заказов, среднего и медианного чека
- Перенес подготовленные данные в Jupyter Notebook и визуализировал ключевые метрики с помощью Python
- Сформулировал выводы о текущем состоянии бизнеса и изменении структуры покупок
___________
# Учебные проекты
